...
class AskPageViewTests(SimpleTestCase):
    ...
    @mock.patch("queries.views.run_query")
    def test_post_returns_message_when_no_relevant_chunks(self, mock_run_query):
        from queries.services.query_pipeline import QueryResult
    ...
    @mock.patch("queries.views.run_query")
    def test_post_passes_document_id_to_retriever(self, mock_run_query):
        from queries.services.query_pipeline import QueryResult
    ...
    @mock.patch("queries.views.run_query")
    def test_post_includes_x_citations_header(self, mock_run_query):
        from queries.services.query_pipeline import QueryResult
        ...
        self.assertEqual(parsed[0]["document_name"], "Policy.pdf")
...
class QueryAPIViewTests(SimpleTestCase):
    ...
    @mock.patch("queries.views.run_query")
    def test_query_returns_streaming_response_when_chunks_found(self, mock_run_query):
        from queries.services.query_pipeline import QueryResult
    ...
    @mock.patch("queries.views.run_query")
    def test_query_returns_json_when_no_relevant_chunks(self, mock_run_query):
        from queries.services.query_pipeline import QueryResult
    ...
    @mock.patch("queries.views.run_query")
    def test_query_passes_document_id_to_retriever(self, mock_run_query):
        from queries.services.query_pipeline import QueryResult
    ...
    @mock.patch("queries.views.run_query")
    def test_query_includes_x_citations_header(self, mock_run_query):
        from queries.services.query_pipeline import QueryResult
...
class QueryThrottleTests(SimpleTestCase):
    ...
    @mock.patch("queries.views.run_query")
    def test_authenticated_user_is_throttled_after_limit(self, mock_run_query):
...
class AskPageViewLoggingTests(SimpleTestCase):
    ...
    @mock.patch("queries.views.run_query")
    def test_post_logs_received_line_with_truncated_question(self, mock_run_query):
    ...
    @mock.patch("queries.views.run_query")
    def test_post_logs_no_relevant_info_path(self, mock_run_query):
    ...
    @mock.patch("queries.views.run_query")
    def test_post_logs_streaming_response_with_prompt_size(self, mock_run_query):
        """Streaming path emits a "Streamed answer" line with citation count."""
        from queries.services.query_pipeline import QueryResult
    ...
    @mock.patch("queries.views.run_query")
    def test_post_truncates_long_questions_in_log(self, mock_run_query):
...
class QueryAPIViewLoggingTests(SimpleTestCase):
    ...
    @mock.patch("queries.views.run_query")
    def test_query_logs_received_line_with_truncated_question(self, mock_run_query):
        """`Query received: "..."` line includes the truncated question and username."""
        from queries.services.query_pipeline import QueryResult
    ...
    @mock.patch("queries.views.run_query")
    def test_query_logs_no_relevant_info_path(self, mock_run_query):
        """No-chunks path emits the "Returned 'no relevant information' response" line."""
        from queries.services.query_pipeline import QueryResult
    ...
    @mock.patch("queries.views.run_query")
    def test_query_logs_streaming_response_with_prompt_size(self, mock_run_query):
        """Streaming path emits a "Streamed answer" line with citation count."""
        from queries.services.query_pipeline import QueryResult
